/**
 * Firebase auth helper for mobile-customer — Sprint 66.
 * Uses the Firebase JS SDK with React Native (AsyncStorage) persistence.
 ...
 *
 * Runtime note: Firebase 10 on Expo needs a metro.config.js that disables
 * package-exports resolution (see metro.config.js in this app). Verify on an
 * EAS / Expo dev build.
 */
